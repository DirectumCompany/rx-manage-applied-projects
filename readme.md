...
Получить url подключения к веб-доступу текущего проекта:
...
Посмотреть краткую информацию по репозиториям проекта - имя текущей ветке, состояние файлов:

```
do map repos
```

### Посмотреть содержимо файла описания проекта

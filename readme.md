...
Штатный инсталлятор Directum RX отлично подходит для установки первого и единственного инстанса Directum RX. Начиная с версии 4.2 Directum RX инсталлятор, в принципе, позволяет установить дополнительные инстансы, но при этом требуется знать некоторые недокументированные возможности DirectumLauncher.
...
5. Установите необходимые компоненты Directum RX. Не рекомендуется копировать архивы компонент из дистрибутива в папку инстанса - занимают слишком много места на диске. Также не рекомендуется устанавливать компоненте WebHelp.zip - она занимает очень много места на диске. Справка доступна на club.directum.ru. Состав компонент зависит от версии RX:
